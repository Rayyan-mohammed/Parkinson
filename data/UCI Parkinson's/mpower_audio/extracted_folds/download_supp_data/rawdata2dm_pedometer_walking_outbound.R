...
####
supp_training <- merge(supp_training,supp_training_json_files, by.x="pedometer_walking_outbound.json.items", by.y="supp_training_json_fileId", all.x=TRUE, all.y=F)
...
pedometer_walking_outbound.json.items_supp.features <- walkFeatures.df %>% filter(idx %in% selected_records)

save(pedometer_walking_outbound.json.items_supp.features, file="pedometer_walking_outbound.json.items_supp.features.rdata")
