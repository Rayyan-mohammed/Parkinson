...
####
testing <- merge(testing,testing_json_files, by.x="pedometer_walking_outbound.json.items", by.y="testing_json_fileId", all.x=TRUE, all.y=F)
...
pedometer_walking_outbound.json.items_testing.features <- walkFeatures.df %>% filter(idx %in% selected_records)

save(pedometer_walking_outbound.json.items_testing.features, file="pedometer_walking_outbound.json.items_testing.features.rdata")
