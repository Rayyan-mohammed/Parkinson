...
####
testing <- merge(testing,testing_json_files, by.x="deviceMotion_walking_rest.json.items", by.y="testing_json_fileId", all.x=TRUE, all.y=F)
...
deviceMotion_walking_rest.json.items_testing.features <- walkFeatures.df %>% filter(idx %in% selected_records)

save(deviceMotion_walking_rest.json.items_testing.features, file="deviceMotion_walking_rest.json.items_testing.features.rdata")
