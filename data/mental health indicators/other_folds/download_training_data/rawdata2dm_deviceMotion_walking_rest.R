...
####
actv_walking <- merge(actv_walking,outbound_Walking_json_files, by.x="deviceMotion_walking_rest.json.items", by.y="outbound_Walking_json_fileId", all.x=TRUE, all.y=F)
...
deviceMotion_walking_rest.json.items.features <- walkFeatures.df %>% filter(idx %in% selected_records)

save(deviceMotion_walking_rest.json.items.features, file="deviceMotion_walking_rest.json.items.features.rdata")
