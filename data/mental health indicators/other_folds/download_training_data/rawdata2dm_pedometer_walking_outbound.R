...
####
actv_walking <- merge(actv_walking,outbound_Walking_json_files, by.x="pedometer_walking_outbound.json.items", by.y="outbound_Walking_json_fileId", all.x=TRUE, all.y=F)
...
pedometer_walking_outbound.json.items.features <- walkFeatures.df %>% filter(idx %in% selected_records)

save(pedometer_walking_outbound.json.items.features, file="pedometer_walking_outbound.json.items.features.rdata")
